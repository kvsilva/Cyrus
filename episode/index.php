...
<div id="content">
            ...
            if ($episode->getSubtitles() !== null) {
                foreach ($episode->getSubtitles() as $subtitle) {
                    if ($subtitle->getAvailable()->value === Availability::AVAILABLE->value) {
                        ...
                        <track src="<?php echo $path ?>" kind="subtitles" srclang="<?php echo $code ?>"
    ...
    <div class="content-wrapper">
        ...
        <div class="episode-information">
            <h3 class="episode-title">Episódio <?php echo $episode->getNumeration() ?>
                - <?php echo $episode->getTitle() ?></h3>
            <!-- 17 de Junho de 2022 -->
